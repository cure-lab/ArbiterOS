...
This layer captures the **extrinsic** attributes of the message flow. These are immutable facts generated by the kernel, infrastructure or the model provider. 
