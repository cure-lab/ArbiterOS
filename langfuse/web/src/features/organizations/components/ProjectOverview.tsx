        ...
        .map((project) => (
          <Card key={project.id}>
            ...
            {!project.deletedAt ? (
              ...
              <CardContent>
                <CardDescription>
                  {t("organizations.projectBeingDeleted")}
                </CardDescription>
              </CardContent>
            )}
          </Card>
...
const DemoOrganizationTile = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>{t("organizations.tryDemo")}</CardTitle>
      </CardHeader>
      <CardContent>{t("organizations.demoDescription")}</CardContent>
      <CardFooter>
        <Button asChild variant="secondary">
          <Link href={`/project/${env.NEXT_PUBLIC_DEMO_PROJECT_ID}/traces`}>
            {t("organizations.viewDemoProject")}
          </Link>
        </Button>
      </CardFooter>
    </Card>
...
const SingleOrganizationPage = ({
  ...
  if (isDemoOrg) {
    return (
      <ContainerPage
        headerProps={{
          title: t("organizations.demoOrganization"),
        }}
      >
  ...
  return (
    <ContainerPage
      headerProps={{
        title: org?.name ?? t("organizations.organizationFallback"),
  ...
  return (
    <ContainerPage
      headerProps={{
        ...
        breadcrumb: [
          {
            name: t("organizations.pageTitle"),
            href: "/",
          },
        ],
        actionButtonsRight: (
      ...
      <CardContent>
        <CardDescription>
          {canCreateOrgs
            ...
            : t("organizations.getStartedInviteOnly")}
        </CardDescription>
      </CardContent>
