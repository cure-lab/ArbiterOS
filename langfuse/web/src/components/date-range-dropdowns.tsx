          ...
          const itemObj = (
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span>{getLocalizedTimeRangeLabel(item, language)}</span>
              </div>
            </SelectItem>
          );
